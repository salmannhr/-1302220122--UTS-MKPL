...
public class Employee {
    ...
    private static final int SALARY_GRADE_1 = 3_000_000;
    private static final int SALARY_GRADE_2 = 5_000_000;
    private static final int SALARY_GRADE_3 = 7_000_000;
    ...
    public void setMonthlySalary(int grade) {
        ...
        switch (grade) {
            case 1:
                baseSalary = SALARY_GRADE_1;
                break;
            case 2:
                baseSalary = SALARY_GRADE_2;
                break;
            case 3:
                baseSalary = SALARY_GRADE_3;
                break;
            default:
    ...
    public void setSpouse(String spouseName, String spouseIdNumber) {
        ...
        this.spouseIdNumber = idNumber; // ❗️BUG: akan kita perbaiki di refactor selanjutnya
    }
